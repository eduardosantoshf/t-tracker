...
public class StockController {
    ...
    public ResponseEntity<List<Stock>> addLabStock(@RequestBody Stock stock, HttpServletRequest request) {
    ...
    public ResponseEntity<List<Stock>> removeLabStock(@RequestBody Stock stock, HttpServletRequest request) {
